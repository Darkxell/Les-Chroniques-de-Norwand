...
public class Inventory {
     ...
     * 
     * @param e
     *            the equipable that must be removed
     */
     ...
     * 
     * @param c
     *            the capacity that must be removed
     */
     ...
     * 
     * @param e
     *            the equipable that must be added
     */
     ...
     * 
     * @param c
     *            the capacity that must be added
     */
     ...
     * 
     * @param c
     *            the capacity that must be equiped
     */
     ...
     * 
     * @param e
     *            the equipable that must be equiped
     */
