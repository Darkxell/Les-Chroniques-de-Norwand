 ...
 */
public class PnjMerchant extends TileEntity {

    private String message;
    private int sprite_counter;

    public PnjMerchant(Floor roompointer, double x, double y, String message) {
    ...
    public Pixmap getCurrentSprite() {
        return ImagesHolder.entityset.getTile((sprite_counter < 25) ? 1795 : 1803);
    }
