 ...
 */
public class PnjGuard extends TileEntity {

    private String message;
    private int sprite_counter;

    public PnjGuard(Floor roompointer, double x, double y, String message) {
    ...
    public Pixmap getCurrentSprite() {
        return ImagesHolder.entityset.getTile((sprite_counter < 25) ? 1793 : 1801);
    }
