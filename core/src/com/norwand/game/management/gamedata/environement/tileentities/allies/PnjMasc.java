 ...
 */
public class PnjMasc extends TileEntity {

    private String message;
    private int sprite_counter;

    public PnjMasc(Floor roompointer, double x, double y, String message) {
    ...
    public Pixmap getCurrentSprite() {
        return ImagesHolder.entityset.getTile((sprite_counter < 25) ? 1792 : 1800);
    }
