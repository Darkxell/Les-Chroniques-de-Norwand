...
public abstract class Floor {
     ...
     * @param x the x position where to draw the floor. This value represents
     *          the x position on the floor to be drawn on the left side.
     * @param y the y position where to draw the floor. This value represents
    ...
    public void actClosest() {
        ...
        for (int i = 0; i < tileentities.length; i++)
            if (tileentities[i].canActWith()
                    ...
                    .getDistanceFrom(playerpos) < te_dist) {
