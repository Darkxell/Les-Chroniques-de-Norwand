...
public class Floor_Wastelands extends Floor {
	...
	setTileAt(44, 49,new WarpZone(getTileAt(44, 49), 16, 0) {
	    @Override
	    public Floor getDestination() {
		return new Floor_WastelandsS(GameData.get().player);
	    }
	});
	setTileAt(45, 49,new WarpZone(getTileAt(45, 49), 17, 0) {
	    @Override
	    public Floor getDestination() {
		return new Floor_WastelandsS(GameData.get().player);
	    }
	});
	setTileAt(46, 49,new WarpZone(getTileAt(46, 49), 18, 0) {
	    @Override
	    public Floor getDestination() {
		return new Floor_WastelandsS(GameData.get().player);
	    }
	});
	setTileAt(47, 49,new WarpZone(getTileAt(47, 49), 19, 0) {
	    @Override
	    public Floor getDestination() {
		return new Floor_WastelandsS(GameData.get().player);
	    }
	});
	setTileAt(48, 49,new WarpZone(getTileAt(48, 49), 20, 0) {
	    @Override
	    public Floor getDestination() {
		return new Floor_WastelandsS(GameData.get().player);
	    }
	});
	setTileAt(49, 49,new WarpZone(getTileAt(49, 49), 21, 0) {
	    @Override
	    public Floor getDestination() {
		return new Floor_WastelandsS(GameData.get().player);
	    }
	});
	setTileAt(50, 49,new WarpZone(getTileAt(50, 49), 22, 0) {
	    @Override
	    public Floor getDestination() {
		return new Floor_WastelandsS(GameData.get().player);
	    }
	});
	setTileAt(51, 49,new WarpZone(getTileAt(51, 49), 23, 0) {
	    @Override
	    public Floor getDestination() {
		return new Floor_WastelandsS(GameData.get().player);
	    }
